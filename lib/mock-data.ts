...
export const initialSports: Sport[] = [
  { id: '11111111-1111-1111-1111-111111111111', name: 'Football', type: 'team', venue: 'Main Outdoor Turf Stadium', image_url: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=800&auto=format&fit=crop' },
  ...
  { id: '44444444-4444-4444-4444-444444444444', name: 'Carrom', type: 'duo', venue: 'Student Activity Center', image_url: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800&auto=format&fit=crop' },
]
