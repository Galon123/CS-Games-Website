...
export default function BadmintonHeroCarousel() {
  ...
  const handleSaveImages = async () => {
    ...
    await updateBadmintonCarouselImages(validImages)
    setCurrentIndex(0)
    setSaveSuccessMsg('Badminton carousel images updated successfully!')
    setTimeout(() => {
  ...
  const handleResetDefaults = async () => {
    if (confirm('Reset carousel back to the default badminton tournament images?')) {
      await resetBadmintonCarouselImages()
      setDraftImages(DEFAULT_BADMINTON_CAROUSEL_IMAGES)
      setCurrentIndex(0)
  ...
  return (
    <>
      <section
        ...
        aria-label="Badminton Presentation Showcase"
        tabIndex={0}
      ...
      >
              ...
              >
                ...
                <div className="absolute inset-0 overflow-hidden">
                  {!isFailed ? (
                    ...
                    <img
                      src={imageUrl}
                      alt="Badminton Championship Showcase"
        ...
        <div className="absolute top-4 right-4 sm:top-5 sm:right-6 z-30 flex items-center space-x-2">
          {isAdmin ? (
            <button
              ...
              title="Admin: Edit Badminton Hero Carousel Images"
            >
        ...
        <div className="absolute left-6 sm:left-10 lg:left-14 bottom-6 sm:bottom-10 z-20 flex items-center space-x-3">
          ...
          {slides.length > 1 && (
            <div
              role="tablist"
              aria-label="Badminton Presentation Carousel Slides"
      ...
      {/* ─────────────────────────────────────────────────────────────
          ...
          badminton carousel images with instant live previews.
          ───────────────────────────────────────────────────────────── */}
      {isEditorOpen && (
        <div
          role="dialog"
        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between border-b border-white/10 pb-4">
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs font-mono text-fog">Badminton Hero Showcase</span>
                </div>
                ...
                <p className="text-xs text-mist mt-0.5 font-sans">
                  Customize the presentation photos shown in the hero carousel of the Badminton page.
                </p>
              </div>
            ...
            {/* Quick-Add Curated Badminton Presets */}
            <div className="space-y-2">
              <span className="text-[11px] font-mono uppercase tracking-wider text-fog font-bold flex items-center space-x-1">
                ...
                <span>Quick-Add Curated Badminton Presets</span>
              </span>
              <div className="flex flex-wrap gap-2">
                {BADMINTON_PRESET_SUGGESTIONS.map((preset, pIdx) => {
            ...
            <div className="flex items-start justify-between">
              <div className="space-y-1">
                ...
                <p className="text-xs text-mist">
                  Enter admin credentials to customize the badminton hero carousel images.
                </p>
              </div>
              <button
                onClick={() => setIsAuthOpen(false)}
