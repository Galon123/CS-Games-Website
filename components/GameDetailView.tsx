...
export default function GameDetailView({ sportSlug }: GameDetailViewProps) {
  ...
  const { sports, teams, players, matches, leaderboards } = useTournament()
  ...
  return (
    <div className="space-y-10 pb-20">
      ...
      {/* ─────────────────────────────────────────────────────────────
          2. EDITORIAL HERO FOR THIS DEDICATED GAME
          Noir Editorial atmosphere, photographic scrim, venue & metrics
          ───────────────────────────────────────────────────────────── */}
